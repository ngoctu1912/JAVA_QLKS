...
//     public HoaDonDTO(String maHD, String maCTT, int tienP, int tienDV, int giamGia, int phuThu, int tongTien, Date ngayThanhToan, String hinhThucThanhToan, int xuLy) {
//         this.maHD = maHD;
//         this.maCTT = maCTT;
//         this.tienP = tienP;
//         this.tienDV = tienDV;
...
//     public int getTienP() { return tienP; }
//     public void setTienP(int tienP) { this.tienP = tienP; }
//     public int getTienDV() { return tienDV; }
//     public void setTienDV(int tienDV) { this.tienDV = tienDV; }
//     public int getGiamGia() { return giamGia; }
//     public void setGiamGia(int giamGia) { this.giamGia = giamGia; }
//     public int getPhuThu() { return phuThu; }
//     public void setPhuThu(int phuThu) { this.phuThu = phuThu; }
...
//     public int getXuLy() { return xuLy; }
//     public void setXuLy(int xuLy) { this.xuLy = xuLy; }
// }
