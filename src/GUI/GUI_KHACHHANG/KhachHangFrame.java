...
//     public KhachHangFrame(JFrame parentFrame, int manhomquyen, String chucnang) {
...
//         tableKhachHang.setBackground(new Color(0xA1D6E2)); // Đặt màu giống FormPhong (giả định)
...
//             if (i != 2 && i != 5 && i != 7) { // Không căn giữa cột "Tên KH", "Địa Chỉ", "Email"
//                 columnModel.getColumn(i).setCellRenderer(centerRenderer);
//             }
//         }

//         // Thiết lập kích thước cột
//         tableKhachHang.getColumnModel().getColumn(0).setPreferredWidth(50); // STT
//         tableKhachHang.getColumnModel().getColumn(1).setPreferredWidth(100); // Mã KH
//         tableKhachHang.getColumnModel().getColumn(2).setPreferredWidth(150); // Tên KH
//         tableKhachHang.getColumnModel().getColumn(3).setPreferredWidth(80); // Giới Tính
//         tableKhachHang.getColumnModel().getColumn(4).setPreferredWidth(100); // CCCD
//         tableKhachHang.getColumnModel().getColumn(5).setPreferredWidth(120); // Địa Chỉ (giảm từ 150)
//         tableKhachHang.getColumnModel().getColumn(6).setPreferredWidth(120); // SĐT
//         tableKhachHang.getColumnModel().getColumn(7).setPreferredWidth(200); // Email
//         tableKhachHang.getColumnModel().getColumn(8).setPreferredWidth(80); // Trạng Thái
//         tableKhachHang.getColumnModel().getColumn(9).setPreferredWidth(100); // Ngày Sinh
...
//             result = khachHangBUS.selectAll();
//             result.removeIf(kh -> !String.valueOf(kh.getMaKhachHang()).contains(keyword));
//         } else if (type.equals("Tên KH")) {
//             result = khachHangBUS.selectAll();
//             result.removeIf(kh -> !kh.getTenKhachHang().toLowerCase().contains(keyword));
//         } else if (type.equals("SĐT")) {
//             result = khachHangBUS.selectAll();
//             result.removeIf(kh -> !kh.getSoDienThoai().contains(keyword));
//         } else if (type.equals("CCCD")) {
//             result = khachHangBUS.selectAll();
//             result.removeIf(kh -> !String.valueOf(kh.getCccd()).contains(keyword));
//         } else if (type.equals("Trạng Thái")) {
//             result = khachHangBUS.selectAll();
//             if (keyword.contains("hoạt động")) {
//                 result.removeIf(kh -> kh.getTrangThai() != 1);
//             } else if (keyword.contains("ngưng")) {
//                 result.removeIf(kh -> kh.getTrangThai() != 0);
//             }
//         }
