...
public class DoanhThuTheoKhoangNgayComponent extends JPanel {
    ...
    private void initComponents() {
        ...
        for (String subTab : subTabs) {
            ...
            subTabButton.setBackground(subTab.equals("Thống kê từ ngày đến ngày") ? Color.WHITE : Color.decode("#E6F4F1"));
    ...
    public ArrayList<ThongKeDTO> getRangeData() { return rangeData; }
    public void setRangeData(ArrayList<ThongKeDTO> rangeData) { this.rangeData = rangeData; }
    ...
    public static void setSharedStartDate(LocalDate date) { sharedStartDate = date; }
    public static LocalDate getSharedEndDate() { return sharedEndDate; }
    public static void setSharedEndDate(LocalDate date) { sharedEndDate = date; }
}