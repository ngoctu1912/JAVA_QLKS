...
public class DoanhThuTheoThangComponent extends JPanel {
    ...
    private DoanhThuTheoThangEvent eventHandler;
    private static int sharedYear = 2025;

    public DoanhThuTheoThangComponent(ThongKeBUS thongKeBUS) {
        this.thongKeBUS = thongKeBUS != null ? thongKeBUS : new ThongKeBUS();
        eventHandler = new DoanhThuTheoThangEvent(this, this.thongKeBUS);
    ...
    private void initComponents() {
        ...
        for (String subTab : subTabs) {
            ...
            subTabButton.setBackground(subTab.equals("Thống kê từng tháng trong năm") ? Color.WHITE : Color.decode("#E6F4F1"));
        ...
        chartPanel = new JPanel() {
            ...
            public Dimension getPreferredSize() {
                int numMonths = monthlyData != null ? monthlyData.size() : 1;
                int minWidth = Math.min(numMonths * 50, 900); // Giới hạn chiều rộng tối đa 900
        ...
        // Bảng doanh thu
        String[] columns = {"Tháng", "Doanh thu phòng", "Doanh thu dịch vụ", "Tổng doanh thu"};
    ...
    public ArrayList<ThongKeDTO> getMonthlyData() { return monthlyData; }
    public void setMonthlyData(ArrayList<ThongKeDTO> monthlyData) { this.monthlyData = monthlyData; }
