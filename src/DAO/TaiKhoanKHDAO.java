...
//     @Override
//     public TaiKhoanKHDTO selectById(String tdn) {
...
//     public TaiKhoanKHDTO selectByMaKhachHang(int maKhachHang) {
...
//     //             "WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'KHACHHANG'";
//     //     try (Connection conn = ConnectDB.getConnection();
//     //          Statement stmt = conn.createStatement();
//     //          ResultSet rs = stmt.executeQuery(sql)) {
//     //         if (rs.next()) {
...
//     //         }
//     //     } catch (SQLException e) {
//     //         System.err.println("Lỗi lấy AUTO_INCREMENT KHACHHANG: " + e.getMessage());
//     //     }
//     //     return -1;
//     // }
// }
...
//     public int getAutoIncrement() {
//         String sql = "SELECT MAX(MKH) AS max_id FROM KHACHHANG"; // Lấy từ KHACHHANG
//         try (Connection conn = ConnectDB.getConnection();
//              PreparedStatement stmt = conn.prepareStatement(sql);
//              ResultSet rs = stmt.executeQuery()) {
//             if (rs.next()) {
//                 int maxId = rs.getInt("max_id");
//                 int nextId = rs.wasNull() ? 1 : maxId + 1;
//                 if (nextId <= 0) {
//                     throw new IllegalStateException("Mã khách hàng tiếp theo không hợp lệ: " + nextId);
//                 }
//                 return nextId;
//             }
//         } catch (SQLException e) {
//             System.err.println("Lỗi lấy mã khách hàng tiếp theo: " + e.getMessage());
//             throw new RuntimeException("Không thể lấy mã khách hàng: " + e.getMessage());
//         }
//         return 1; // Mặc định trả về 1 nếu bảng trống
//     }
// }