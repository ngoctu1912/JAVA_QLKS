...
public class ThongKeDAO implements DAOinterface<Object> {
    ...
    public ArrayList<ThongKeDTO> getDoanhThuTheoLoaiPhong(LocalDate startDate, LocalDate endDate) {
        ...
        try (PreparedStatement stmt = conn.prepareStatement(query)) {
            ...
            System.err.println("Lỗi khi truy vấn doanh thu theo loại phòng từ " + startDate + " đến " + endDate + ": " + e.getMessage());
            e.printStackTrace();
        }
    ...
    public ArrayList<KhachHangThongKeDTO> getKhachHangTheoKhoangNgay(LocalDate startDate, LocalDate endDate) {
        ...
        try (PreparedStatement stmt = conn.prepareStatement(query)) {
            ...
            System.err.println("Lỗi khi truy vấn thông tin khách hàng từ " + startDate + " đến " + endDate + ": " + e.getMessage());
            e.printStackTrace();
        }
    ...
    public ArrayList<ThongKeDTO> getDoanhThu8NgayGanNhat() {
        ...
        while (!currentDate.isAfter(today)) {
            ...
            try (PreparedStatement stmt = conn.prepareStatement(query)) {
                ...
                System.err.println("Lỗi khi truy vấn doanh thu 8 ngày gần nhất cho ngày " + formattedDate + ": " + e.getMessage());
                e.printStackTrace();
            }
            currentDate = currentDate.plusDays(1);
        }
